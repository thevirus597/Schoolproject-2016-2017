...
<!--Slideshow HTML-->
	<div class="container">
				...
				<div id="cbp-bicontroles" class="cbp-bislideshow"
								...
								<div class="card card-signup" style="margin-top: 200px; width: 400px; height: 230px;" =>
								...
								<div class="simple-text form-group">
									<p class="text-center ">De gegevens die u heeft ingevuld zijn incorrect</p>
								</div>


								<div class="footer text-center" style="margin-bottom:200px">
								<a href="index.php" type="submit" class="btn btn-simple btn-primary btn-lg" name="login">Opnieuw proberen</a>
								</div>
